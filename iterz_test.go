...
func all[V any](v V) bool              { return true }
func all2[K any, V any](k K, v V) bool { return true }
func odd(i int) bool                   { return i%2 == 1 }
func oddValue(k int, v int) bool       { return v%2 == 1 }
func oddKey(k int, v int) bool         { return k%2 == 1 }
